...
const subtitle = "Let investors cook";
const description =
  "A collection of simple tools and applications (recipes) for the data-fetish retail investor.";
...
export default {
  ...
  head: `
    ...
    <meta name="description" content=${JSON.stringify(subtitle + " — " + description)}>
  ...
  footer: `
    ...
    <strong>
      <a
        href="https://github.com/mcieno/marketchef"
